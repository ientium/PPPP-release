...
insert  into `antispam_blacklist`(`word`) values ('4GAMEPOWER'),('ELYSIUMAEWOW'),('ELYSIUMKYWOW'),('ELYSIUMORWOW'),('ELYSIUMRDWOW'),('ELYSIUMRSWOW'),('G4W@W'),('G4WOW'),('GOLD4MMO'),('GOLDCEO'),('GOLDDEAL'),('GOLDINSIDER'),('ILOVEUGOLD'),('ITEM4GAME'),('ITEM4WOW'),('MMOGO'),('MMOLORD'),('MMOOK'),('MMOSE'),('MMOTANK'),('MONEYFORGAMES'),('NOST100'),('NOST1OO'),('OKOGAME'),('OKOGAMES'),('OKOGOMES'),('PVPBANK'),('RNRNOOK'),('RNRNOSE'),('SELLNGOLD'),('SINBAGAME'),('SINBAGOLD'),('SINBAONLINE'),('SUSANGAME'),('WOWMARY'),('WTSITEM'),('X2GOLD'),('XIAOBAIMOSHOUJINGJI');
