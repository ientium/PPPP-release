...
void WardenWin::RequestData()
{
    ...
    // header
    wd = _wardenStorage.GetCheckDataById(1, 5875, true);
...
void WardenWin::RequestData2()
{
    ...
    // header
    WardenCheck* wd = _wardenStorage.GetCheckDataById(2, 5875, true);
    ...
    {
        wd = _wardenStorage.GetCheckDataById(3, 5875, true);
        buff << uint32(wd->address);
        buff << uint8(wd->length);
        dataCreate = true;
    }
    ...
    {
        wd = _wardenStorage.GetCheckDataById(4, 5875, true);
    ...
    {
        wd = _wardenStorage.GetCheckDataById(5, 5875, true);
        offset += wd->address;
        buff << uint32(offset);
        buff << uint8(wd->length);
        dataCreate = true;
